...
export default function FindThemGigs(){
    ...
    return(
        <div className="section_box flex justify-center items-center relative animate-appear">
            ...
            <div className="pick_them_gigs relative grid">
                <div className="content flex flex-col justify-around items-start">
                    ...
                    <div className="footer_btn flex justify-around">
                        ...
                        <div className="btn h-20 w-56  flex justify-center items-center transition-all duration-300 hover:translate-x-[-4px] hover:translate-y-[-4px] hover:rounded-md hover:shadow-[4px_4px_0px_grey] active:translate-x-[0px] active:translate-y-[0px] active:rounded-2xl active:shadow-none"><Button placeholder={"COLLABORATIVE GIGS"}/></div>
                    </div>
                </div>
